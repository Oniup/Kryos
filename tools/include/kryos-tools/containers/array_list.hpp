...
//
// /**
//  * @brief Get the max space available for new elements that doesn't require a heap allocation
//  call
//  *
//  * @param p_list Array list to get length
//  * @param type_size Size of the array list type in bytes
...
//  *
//  * @return Result struct determining whether the function failed and a pointer to the array list
//  as
//  * a `void*`
//  */
...
//  * a `void*`
//  */
// _kint_array_list_result_t _kint_resize_array_list_size(void* p_list, usize type_size, usize
// count);
//
// /**
...
//
// /**
//  * @brief Copies the given data into the front of array list and shifts the original data down
//  the
...
//     create_array_list_with_type_size_and_capacity(size,
//     ARRAY_LIST_DEFAULT_CAPACITY_INCREASE_COUNT)
//
// /**
//  * @brief Get the number of elements within the array list
//  *
